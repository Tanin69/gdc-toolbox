<template>
  ...
  <div v-else-if="!pending && !mission">Huston...</div>
  <div v-else>
    <!--Titre briefing-->
    <div class="w3-container">
      <div class="gdc-briefing-title">
        {{ mission.missionTitle.val }}
      </div>
    </div>
            ...
            <ul class="w3-ul">
              <li class="w3-bar">
                <div class="w3-bar-item">
                  <span>Carte&nbsp;:&nbsp;</span>
                  <span>{{ mission.missionMap.val }}</span>
                </div>
              </li>
              <li class="w3-bar">
                <div class="w3-bar-item">
                  <span>Version&nbsp;:&nbsp;</span>
                  <span>{{ mission.missionVersion.val }}</span>
                </div>
              </li>
              <li class="w3-bar">
                <div class="w3-bar-item">
                  <span>Type de jeu&nbsp;:&nbsp;</span>
                  <span>{{ mission.gameType.val }}</span>
                </div>
              </li>
              <li class="w3-bar">
                <div class="w3-bar-item">
                  <span>Texte lobby&nbsp;:&nbsp;</span
                  ><span>{{ mission.overviewText.val }}</span>
                </div>
              </li>
              <li class="w3-bar">
                <div class="w3-bar-item">
                  <span>Auteur&nbsp;:&nbsp;</span>
                  <span>{{ mission.author.val }}</span>
                </div>
              </li>
              <li class="w3-bar">
                <div class="w3-bar-item">
                  ...
                  <span>
                    Minimum : {{ mission.minPlayers.val }}, maximum :
                    {{ mission.maxPlayers.val }}
                  </span>
                </div>
              </li>
            </ul>
...
const { pending, data: mission } = useLazyFetch<Mission | null>(
