...
callShowMission = function(e,cell) {
    window.open("http://localhost:3100/mission/show/" + cell.getData().missionPbo.val, "_blank");   
};
...
const table = new Tabulator("#missionsList", {
    ajaxURL:"http://localhost:3000/api/mission/list", //ajax URL (should not be harcoded)
    ...
    columns:[
        ...
        //{title:"Date de publication", field:"pboFileDateM.val", align:"right", width: 140, responsive:3},
        ...
        {title:"Texte lobby", field:"overviewText.val", width: 770, tooltip:true, responsive:3, formatter:customFalseFmt},
